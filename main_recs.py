...
def dataset_from_performance_file(file: str) -> str:
    """
...
def find_best_performance_files(dataset: str, dataset_name: str) -> list:
...
if __name__ == "__main__":
    ...
    dataset_name = f'{args.dataset}_{args.type}_{args.score_type}_epsrr{args.eps_rr}_epsexp{args.eps_exp}'
